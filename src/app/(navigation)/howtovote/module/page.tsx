...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <p className='text-24px w-[851px] text-slategray'>Our brand identity system expresses our spirits and inspires our behaviors. The current system consists of 9 core elements that help unify and communicate Campoal brand with consistency and clarity.</p>
          ...
          <div key={module.id} className='relative' >
            ...
            >
              ...
              <div className='p-[24px]'>
                ...
                {/*}<p className='leading-[22px] text-slategray'>{module.title}</p>*/}
              </div>
            </Link>
